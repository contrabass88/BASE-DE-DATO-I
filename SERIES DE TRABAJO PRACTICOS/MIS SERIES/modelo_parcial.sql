...
(
  ...
  monodroga_medic INT NOT NULL,
  presentacion_medic INT NOT NULL,
...
(
  ...
  desc_motivoVisita INT NOT NULL,
...
(
  ...
  motivo_citaMedica INT NOT NULL,
...
INSERT INTO Citas_medica (id_citaMedica, fecha_citaMedica, id_motivo_citaMedica, observaciones_citaMedica, id_motivoVisita, id_tratamiento, id_mascota) VALUES
(1, '2024-09-20', 1, 'Todo en orden, se recomienda revisión en 6 meses.', 1, 1, 1),
(2, '2024-09-22', 2, 'Aplicación de vacunas y control de peso.', 2, 2, 2),
(3, '2024-09-25', 3, 'Requiere análisis adicionales para determinar el alérgeno.', 3, 3, 3);
