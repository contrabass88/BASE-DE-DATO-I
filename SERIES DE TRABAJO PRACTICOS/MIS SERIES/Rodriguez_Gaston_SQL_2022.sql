...
VALUES (41123456, 'Carlos', 'López', 'Av. Siempre Viva 123', 'Buenos Aires', 'carlos.lopez20@mail.com', 1034567890),
       (40234567, 'Ana', 'Martínez', 'Calle Falsa 456', 'Córdoba', 'ana.martinez@mail.com', 1123456789);
select * from CLIENTE;

ALTER TABLE CLIENTE
ALTER COLUMN email VARCHAR(100);  -- Aumenta el tamaño de la columna email
